...
async def test_cleaner_dry_run(mock_client, mock_checker):
    ...
    # Ensure move_to_trash was NOT called in dry-run
...
async def test_cleaner_real_run(mock_client, mock_checker):
    ...
    # Ensure move_to_trash was called for the broken bookmark
    mock_client.move_to_trash.assert_called_once_with(2)
